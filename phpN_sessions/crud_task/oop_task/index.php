...
<!-- Mirrored from themeht.com/loptus/html/blog-grid-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Jun 2020 12:21:01 GMT -->
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="post">
                                    <div class="post-image">
                                        <img class="img-fluid h-100 w-100" src="<?php echo url($raw['image']); ?>" alt="">
                                    </div>
                                    <div class="post-desc">

                                        <div class="post-title">
                                            <h5><a href="blog-details.html"><?php echo $raw['title'] ;?></a></h5>
                                        </div>
                                        <p><?php echo substr($raw['content'], 0, 100) ;?></p>
